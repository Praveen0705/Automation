...
public class nykaa {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement ff=driver.findElement(By.xpath("//button[text()='Continue as guest']"));
		ff.click();

		WebElement ff2=driver.findElement(By.xpath("//div[@class='css-gecnnw eqr1d9n12']"));
		ff2.click();
		WebElement ff3=driver.findElement(By.xpath("(//span[@class='css-1b232xc ehes2bo3'])[2]"));
		ff3.click();
		WebElement ff4=driver.findElement(By.xpath("(//p[@class='css-masf0q eka6zu20'])[2]"));
		String rate2=ff4.getText();
